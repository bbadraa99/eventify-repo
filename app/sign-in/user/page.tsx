...
const SigninPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center pt-10 lg:pt-16  bg-background-10 flex-col justify-items-stretch">
      ...
      <div className="bg-white p-8 rounded shadow-md w-full max-w-md justify-self-center">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            <button
              type="submit"
              className="w-full bg-background-10 text-black border-2 border-gray-400 px-4 py-2 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
              Sign In
            </button>
          </div>
      ...
      <p className='pt-4'>Don't have an account? <Link href="/sign-up/user" className='text-bold text-black'>Sign up</Link></p>
    </div>
  );
};
